...
def find_run_average(GAMMA):
    raw_values = []
    average_rewards = []
    # Load raw data
    with open(f"../documentation/RawReward{GAMMA}.csv", 'r') as raw:
    ...
    with open(f"../documentation/Averages/AverageReward-{GAMMA}-.csv", "w", newline="") as average:
