...
def find_run_average(ALPHA):
    raw_values = []
    average_rewards = []
    # Load raw data
    with open(f"../documentation/RawReward{ALPHA}.csv", 'r') as raw:
    ...
    with open(f"../documentation/Averages/AverageReward-{ALPHA}-.csv", "w", newline="") as average:
